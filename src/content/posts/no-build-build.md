---
author: "Charles Hood"
pubDatetime: 2026-07-08T00:26:18.000Z
title: "The No-Build Build: A Stealth Camper Made of Nothing but Store-Bought Crap"
description: "A stealth camper with no build at all: store-bought gear strapped into a Ford E-Transit, 89 kWh of factory battery, and a plan to sleep at the charger."
draft: false
ogImage: "https://charleshood.net/blog-images/no-build-build/media/og-card.jpg"
tags:
  - "Camper Van"
  - "Electric Vehicles"
  - "Ford"
...
<img src="/blog-images/no-build-build/media/electrical.png" alt="Electrical diagram showing the E-Transit traction pack feeding Pro Power Onboard outlets, which power the portable AC, induction hob, chest fridge, and small loads, with a 120V load budget chart" style="width: 100%; height: auto; margin: 0 0 8px 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">

<p style="text-align: center; font-size: 0.85em; opacity: 0.75; margin: 0 0 24px 0;"><em>The entire electrical system. The induction hob is the one optional cooking appliance, and the only rule is it never runs at max alongside the AC.</em></p>
...
<img src="/blog-images/no-build-build/media/plan-view.png" alt="Scale floor plan of the E-Transit cargo area showing eight zones: cab curtain, kitchen table, fridge, cot, stowed toilet, portable AC, clear aisle, and a kept-clear sliding door" style="width: 100%; height: auto; margin: 0 0 8px 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">

<p style="text-align: center; font-size: 0.85em; opacity: 0.75; margin: 0 0 24px 0;"><em>The floor plan. Eight zones, one clear aisle, and every piece of furniture strapped to a factory D-ring.</em></p>
...
<img src="/blog-images/no-build-build/media/penetration.png" alt="Section drawing of the single body penetration: a 12 by 6 inch louvered vent in the rear door where both AC hoses terminate, sealed with butyl and a backing plate" style="width: 100%; height: auto; margin: 0 0 8px 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">

<p style="text-align: center; font-size: 0.85em; opacity: 0.75; margin: 0 0 24px 0;"><em>The one hole in the van. Both AC hoses exit through a single louvered vent that reads as a fleet equipment vent.</em></p>
...
<img src="/blog-images/no-build-build/media/exterior.png" alt="Exterior spec sheet of the finished van: a plain white Ford E-Transit with no windows, no decals, no roof rack, and one small louvered vent on a rear door" style="width: 100%; height: auto; margin: 24px 0 8px 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">

<p style="text-align: center; font-size: 0.85em; opacity: 0.75; margin: 0;"><em>The finished product, from the only angle anyone will ever see it.</em></p>
